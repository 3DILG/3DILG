...
from datasets import build_shape_surface_occupancy_dataset, build_scene_surface_occupancy_dataset
...
def get_args():
    ...
    # Model parameters
    parser.add_argument('--model', default='ae_192_8_32', type=str,
    ...
    parser.add_argument('--dataset', default='object')
...
def main(args, ds_init):
    ...
    if args.dataset == 'object':
        ...
        dataset_train  = build_scene_surface_occupancy_dataset('train', args=args)
        if args.disable_eval:
            dataset_val = None
        else:
            dataset_val = build_scene_surface_occupancy_dataset('val', args=args)
    ...
    if args.init is not None:
        model.load_state_dict(torch.load(args.init, map_location='cpu')['model'], strict=False)
